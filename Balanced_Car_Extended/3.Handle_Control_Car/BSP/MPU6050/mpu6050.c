...
void MPU6050_initialize(void) {
    ...
    MPU6050_setI2CMasterModeEnabled(0);	                // Prevent MPU6050 from controlling AUXI2C
    MPU6050_setI2CBypassEnabled(0);                 // I2C of the host controller and AUXI2C of the MPU6050 are directly closed
}
...
{	   
	  ...
	  Temp=(I2C_ReadOneByte(devAddr,MPU6050_RA_TEMP_OUT_H)<<8)+I2C_ReadOneByte(devAddr,MPU6050_RA_TEMP_OUT_L);
		if(Temp>32768) Temp-=65536;	//Data type conversion
		Temp= (36.53f+Temp/340.0f)*10;	  //Store at ten times the temperature
	  return (int)Temp;
}
//------------------End of File----------------------------
